	    ...
	    layui.use('table', function(){
    	  ...
    	  //第一个实例
    	    var talbleIns = table.render({
	    	    elem: '#studetnList',
	    	    //height: 315,
	    	    url: '${url}teacherServlet?type=listScoreLimit&tId=${teacherlogin.tSno }',//数据接口	 
	    	    cols: [[ //表头
	    	      ...
	    	      {field: 'usualResults', title: '平时成绩', sort: true, align: 'center'},	
	    	      {field: 'examResults', title: '实验成绩', align: 'center'}, 
	    	      {field: 'experimentalResults', title: '考试成绩', align: 'center'}, 
	    	      {field: 'totalScore', title: '总成绩', sort: true, align: 'center'}, 
	    	      {title: '操作',fixed: 'right', align:'center', toolbar: '#barDemo', width: 180}
	    	    ]],
	    	    page: {
